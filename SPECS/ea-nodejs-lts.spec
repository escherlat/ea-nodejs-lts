...
Name:          cpanel-%{_base}js-lts
Version:       4.5.0
Release:       %{_build_number}%{?dist}
Provides:      %{_base}js(engine)
Summary:       Node.js is a server-side JavaScript environment that uses an asynchronous event-driven model.
Packager:      Kenneth Power <kenneth.power@gmail.com>
...
%changelog
* Tue Sep 20 2016 Kenneth Power <kenneth.power@gmail.com> 6.6.0-1
- Adapted Fedoras SPEC file for use with cPanel & WHM
